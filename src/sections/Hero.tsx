    ...
    return (
       <section className="h-[492px] md:h-[800px] flex items-center overflow-hidden relative [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]" style={{
        ...
        <motion.div style={{
            ...
            className="absolute h-[344px] w-[344px] md:h-[580px] md:w-[580px] rounded-full border top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-20">
        {/* dot left */}
        ...
        className="absolute h-[444px] w-[444px] md:h-[780px] md:w-[780px] rounded-full border border-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed opacity-20">
                    <div className="absolute h-2 w-2 left-0 rounded-full bg-white top-1/2 -translate-x-1/2 -translate-y-1/2"></div>
        {/* dot top */}
        <div className="absolute h-2 w-2 left-1/2 rounded-full bg-white top-0 -translate-x-1/2 -translate-y-1/2"></div>
        </motion.div>
        ...
        <h1 className="text-8xl md:text-[168px] md:leading-none font-semibold tracking-tighter bg-white bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(79,117,255,0.5))] text-transparent bg-clip-text text-center w-fit pointer-events-none">HTDIB</h1>
        </div>
        <div className="flex items-center justify-center max-w-xl mx-auto">
        <p className="text-lg md:text-xl md:leading-[1.7] text-white/70 mt-5 text-center max-w-xl mx-auto pointer-events-none">Engage In Converstaions With AI and Humans and Learn <span className="text-white">&quot;How To Do Your Task At Hand Better&quot;</span></p>
        </div>
